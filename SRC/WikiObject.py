...
def stopping_criteria(points):
    """stopping_criteria indicates when a single game shall be stopped"""
    deuce(points)
    if deuce_flag == 0:
...
def sim_game(target_score, prob_a):
    ...
    while continue_game:
        ...
        continue_game = stopping_criteria(points)
